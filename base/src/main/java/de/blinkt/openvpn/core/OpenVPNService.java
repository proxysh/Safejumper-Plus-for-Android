...
public class OpenVPNService extends VpnService implements StateListener, Callback, ByteCountListener, IOpenVPNServiceInternal {
    ...
    private static final String PAUSE_VPN = "com.proxy.sh.shieldtra.PAUSE_VPN";
    private static final String RESUME_VPN = "com.proxy.sh.shieldtra.RESUME_VPN";
...
//    }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (intent != null && intent.hasExtra(getPackageName() + ".profileUUID")) {
            ...
            Log.i("OpenVPNService", "Trying to get profile with UUID " + profileUUID);
            Collection<VpnProfile> vpnProfiles = ProfileManager.getInstance(this).getProfiles();
            Log.i("OpenVPNService", "VPN Profiles: " + vpnProfiles.size());
